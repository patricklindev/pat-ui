  ...
  return (
    <div>
      ...
      <Accordion expanded title="Expansion Panel 1">
        More RVs were seen in the storage lot than at the campground.. More RVs
        were seen in the storage lot than at the campground.. More RVs were seen
        in the storage lot than at the campground..
      </Accordion>
      <Accordion title="Expansion Panel 2">
        More RVs were seen in the storage lot than at the campground.. More RVs
        were seen in the storage lot than at the campground..
      </Accordion>
      <Accordion disabled title="Disabled Expansion Panel" expandIcon={heart}>
        Behind the window was a reflection that only instilled fear. More RVs
        were seen in the storage lot than at the campground.. More RVs were seen
        in the storage lot than at the campground.. More RVs were seen in the
        storage lot than at the campground..
      </Accordion>
    </div>
  );
};
...
export const ControlledAccordion = () => {
  const [expanded, setExpanded] = React.useState<string>('panel3');
