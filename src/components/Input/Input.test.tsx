...
describe('Input', () => {
  it('should render default Input', function () {
    ...
    const input_bar = wrapper.getByPlaceholderText(
      'Search...'
    ) as HTMLInputElement;
  ...
  it('should render Transparent Input', function () {
    const wrapper = render(
      <Input transparent placeholder={'Search...'}></Input>
    );
    const input_bar = wrapper.getByPlaceholderText(
      'Search...'
    ) as HTMLInputElement;
  ...
  it('should render Icon Input', function () {
    const wrapper = render(
      <Input icon={'users'} placeholder={'Search...'}></Input>
    );
    const input_bar = wrapper.getByPlaceholderText(
      'Search...'
    ) as HTMLInputElement;
  ...
  it('should render Size Input', function () {
    ...
    for (let s of AllSize) {
      const wrapper = render(
        <Input inputSize={s as any} placeholder={s}></Input>
      );
