...
describe('Range', () => {
    ...
    it("should display different color range slider base upon color props", () => {
        // primary color
       const primaryRangeSlider = render(<Range color='primary' data-testid='primary'/>).getByTestId('primary');
       expect(primaryRangeSlider).toBeInTheDocument();
       expect(primaryRangeSlider).toHaveClass('primary-color');

        // secondary color
        const secondaryRangeSlider = render(<Range color='secondary' data-testid='secondary'/>).getByTestId('secondary');
    ...
    it("should display different size range slider base upon size props", () => {
        // large range slider
        const largeRangeSlider = render(<Range data-testid='large' size='lg'/>).getByTestId('large')
        expect(largeRangeSlider).toBeInTheDocument();
        expect(largeRangeSlider).toHaveClass('custom_thumb_lg');

        // small range slider
        const smallRangeSlider = render(<Range data-testid='small' size='sm'/>).getByTestId('small')
