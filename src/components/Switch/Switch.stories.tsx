...
export const checkedDisabledSwitch = () => (
  <Switch checked disabled />
);

export const labelSwitch = () => <Switch label="Switch Label" onChange={action('Switch clicked')} />;

export const labelDisabledSwitch = () => (
  <Switch label="Switch Label" disabled />
);

export const labelCheckedSwitch = () => (
  <Switch label="Switch Label" checked onChange={action('Switch clicked')} />
);

export const labelCheckedDisabledSwitch = () => (
    <Switch label="Switch Label" checked disabled />
);
